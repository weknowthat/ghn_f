...
import com.example.ghnf.camera.CameraSourcePreview;
...
//    private GestureDetector gestureDetector;
    ...
    /**
     * Initializes the US and creates the detector pipeline.
     */
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //flash switch click
        ((Switch) findViewById(R.id.flash)).setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
     ...
     * showing a "Snackbar meesage of why the permission is needed then
     * sending the request.
     */
     ...
     * at long distances.
     *
     * Suppressing InlineApi since there is a check that the minimum version is net before using
     * the constant.
     */
...
//            new
        ...
        // Create and starts the camera. Note that this uses a higher resolution in comparison
        // to other detection examples to enable the barcode detector to detect small barcodes
        // at long distances.
     ...
     * rest of the precessing pipeline.
     */
    @Override
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                intent.putExtra(MainActivity.ERROR_CODE, "PERMISSION_NOT_GRANTED");
    ...
    private void flashMode(boolean flag){
        Camera camera = getCamera(mCameraSource);
        if (camera != null) {
            try {
                Camera.Parameters param = camera.getParameters();
                param.setFlashMode(flag?Camera.Parameters.FLASH_MODE_TORCH :Camera.Parameters.FLASH_MODE_OFF);
    ...
    public void onBarcodeDetected(Barcode barcode) {
        ...
        Intent intent = new Intent();
        intent.putExtra(MainActivity.SCAN_RESULT, barcode.displayValue);
    ...
    public void onBackPressed() {
        Intent intent = new Intent();
        intent.putExtra(MainActivity.ERROR_CODE, "CAMERA CANCEL");
        setResult(Activity.RESULT_CANCELED, intent);
