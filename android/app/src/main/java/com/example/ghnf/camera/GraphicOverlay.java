package com.example.ghnf.camera;
...
/**
 * A view wihich renders a series of custom graphics to be overlayed on top of a associated preview
 ...
 * supplied value from preview scale to the view scale.</li>
...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
     ...
     * Subclass this and implement the {@link Graphic#draw(Canvas)} method to define the
    ...
    /**
     * Removes a graphics from the overlay
     */
     ...
     * @return list of all active graphic.
     */
